# -*- coding: utf-8 -*-
"""
Created on Sun Nov 13 20:45:14 2016
...
# GOALS
# G1- implement a linear curve fit using Gradient Descent for 6 data points, or a random group of data, using quadratic linear regulator in TensorFlow
